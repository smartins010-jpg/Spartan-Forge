const CACHE='spartan-forge-v10-2';
const APP_SHELL=['./','./index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png','./hero-top-v8.jpg','./splash-helmet.jpg','./strava-config.js'];
