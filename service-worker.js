...
const APP_SHELL=['./','./index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png','./hero-top-v8.jpg','./splash-helmet-v108.png','./exercise-chest-premium.webp','./strava-config.js',
  './exercise-pushup-decline-premium.webp',
  './exercise-lat-pulldown-premium.webp',
  './exercise-lat-pulldown-close-premium.webp',
  './exercise-lat-pulldown-wide-premium.webp',
  './exercise-dumbbell-pullover-premium.webp'];
