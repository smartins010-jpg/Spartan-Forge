const CACHE = 'spartan-forge-v8-41-real-fix-8411';
const APP_SHELL = [
  './','./index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png',
  './hero-top-v8.jpg','./premium-icons/agua.png','./premium-icons/cafe.png',
  './icons-v83/musculacao.jpg','./icons-v83/hiit.jpg','./icons-v83/cardio.jpg','./premium-icons/evolucao.png',
  './ui-icons-v841/alimentacao.svg','./ui-icons-v841/medicoes.svg','./ui-icons-v841/recordes-spartan.svg','./ui-icons-v841/recordes-gerais.svg'
];
