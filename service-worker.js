const CACHE='spartan-forge-v10.21';
const APP_SHELL=['./','./index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png','./splash-helmet-v108.png','./strava-config.js'];
